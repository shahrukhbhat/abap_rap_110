...
define view entity ZRAP110_C_BOOKINGTP_039
  as projection on ZRAP110_R_BOOKINGTP_039
{
  ...
  key     BookingID,
          ...
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZRAP110_CALC_BOOK_ELEM_039'
  ...
  virtual DaysToFlightIndicator  : abap.int1,
          ...
          // public associations
          _Travel : redirected to parent ZRAP110_C_TRAVELTP_039,
          _Customer,
          _Carrier,
          _Connection,
          _Flight,
