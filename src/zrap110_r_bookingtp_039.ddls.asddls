...
define view entity ZRAP110_R_BOOKINGTP_039
  as select from ZRAP110_ABOOK039 as Booking
  association to parent ZRAP110_R_TRAVELTP_039 as _Travel on $projection.TravelID = _Travel.TravelID
